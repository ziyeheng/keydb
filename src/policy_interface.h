...
class policy_entity{
	public:
		...
		int parse_in_json();
		int get_out_json(char *recv_buff_p, int recv_buff_len, int thread_id);
...
//		std::string print_all();
		...
		int do_one_action(http_entity *it_http_p,char *send_buff_p,int buff_len,int &send_len, char *recv_buff_p, int recv_buff_len,int thread_id);
	private:
		http_entity *it_http;
		Json::Value json_in;
		Json::Value json_out;
